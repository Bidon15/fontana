...
class NotificationType(enum.Enum):
    ...
    CELESTIA_COMMITTED = "celestia_committed"  # Block data committed to Celestia DA layer
...
class NotificationManager:
    ...
    def __init__(self):
        ...
        self.webhook_thread = threading.Thread(target=self._run_webhook_loop, daemon=True)
    ...
    def _notify_subscribers(self, subscribers: Set[Callable], data: Dict[str, Any]) -> None:
