...
class CelestiaAccountClient:
    ...
    def get_account_transactions(
        ...
        try:
            ...
            query_events = [f"transfer.recipient='{address}'", f"transfer.sender='{address}'"]
    ...
    def get_deposits_since_height(
        ...
        logger.info(f"Checking for deposits to {vault_address} from height {from_height} to {to_height}")
        ...
        for tx in txs:
            ...
            for msg in tx.messages:
                ...
                if (
                    msg.get("@type", "") == "/cosmos.bank.v1beta1.MsgSend" and
                    msg.get("to_address") == vault_address
                ):
